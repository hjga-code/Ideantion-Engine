...
const AudioInput: React.FC<AudioInputProps> = ({ onAudioCapture, onClear, currentAudio, lang = 'en' }) => {
        ...
        <div className="h-12 w-full max-w-[200px] flex items-center justify-center relative overflow-hidden rounded bg-thinklab-surface/50 border border-thinklab-border">
            ...
            <canvas ref={canvasRef} width="200" height="48" className="w-full h-full opacity-70" />
                ...
                <div className="flex items-center gap-2 px-4 w-full">
                    ...
                    <span className="text-xs text-thinklab-accent font-mono truncate">{lang === 'es' ? 'Audio capturado' : 'Audio captured'}</span>
        ...
        {isRecording ? (
          <div className="flex items-center gap-3">
              ...
              <button
                ...
                title={lang === 'es' ? 'Cancelar grabación (Descartar)' : 'Cancel recording (Discard)'}
              >
              ...
              <button
                ...
                title={lang === 'es' ? 'Detener y Procesar' : 'Stop & Process'}
              >
          ...
          <div className="flex gap-2">
             <button
                ...
                title={lang === 'es' ? 'Grabar Audio' : 'Record Audio'}
              >
              ...
              {currentAudio.blob && (
                  <button 
                    ...
                    title={lang === 'es' ? 'Eliminar Audio' : 'Delete Audio'}
                  >
